...
urlpatterns = [
    ...
    path('api/notif-approved-role/', ExigenceNotiRoleApproveView.as_view(), name='create-email-task'),
    path('api/notif-consulted-role/', ExigenceNotiRoleConsultantView.as_view(), name='create-email-task'),
    path('api/notif-informed-role/', ExigenceNotiRoleInformerView.as_view(), name='create-email-task'),
